...
if (!$conn) {
	...
	$featured_post = mysqli_fetch_assoc($result);
}
...
<section class="featured-posts py-5">
	<div class="container">
		<div class="row">
			<h1 class="mb-3">Featured Posts</h1>
		</div>
		<div class="row border-bottom pb-5 align-items-center">
			<div class="col-lg-6">
				<img src="<?php echo $featured_post['thumbnail']; ?>" class="card-img-top w-100" alt="">
			</div>
			<div class="col-lg-6">
				<div class="card-body">
					<h5 class="card-title"><?php echo $featured_post['title']; ?></h5>
					<p class="card-text"><?php echo $featured_post['excerpt']; ?></p>
					<a href="http://localhost/assignment-8/single-post.php?id=<?php echo $featured_post['id']; ?>" class="btn btn-primary">Read More</a>
				</div>
			</div>
		</div>
		<div class="row pt-4">
